  ...
  return (
    <div className='space-y-3'>
      ...
      <div className='grid grid-cols-1 gap-6 xl:grid-cols-[480px_480px_900px] xl:items-start'>
        ...
        {/* Column 3: Analysis — each logical group below (Stockfish, Player, Master (Our DB),
            Lichess, Chess.com) gets its own tinted wrapper so the grouping is visually obvious;
            individual MyBox panels keep their own look inside. */}
        <div className='w-[900px] rounded-lg space-y-2'>
          {/* Shared heading for the 5 position-specific panels below (Stockfish, Moves
              ...
              not position-specific) now lives in Column 1, below the board. Badge disambiguates
              this route (Player, blue) from MasterGameView_master's identical-looking layout
              (Master, purple) — see the "Games Played showing master data" confusion this was
              added to prevent. FEN/Copy FEN moved here from inside the Stockfish box, so they're
              visible regardless of whether that box is collapsed. */}
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-2'>
              <span className='rounded px-2 py-0.5 text-xs font-bold text-white bg-blue-600'>Player</span>
