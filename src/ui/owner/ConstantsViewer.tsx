...
//
//    Parameters:
//      constantsSections    — sections/entries from constants.ts
//      envSections          — sections/entries from .env
//      functionDescriptions — description text per function/module-scope reference, keyed the
//                             same way as each entry's own consumers strings
//==================================================================================================
