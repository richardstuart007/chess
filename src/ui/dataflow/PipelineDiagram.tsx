...
const NODES: Node<DiagramNodeData>[] = [
  ...
  { id: 'teva',          type: 'diagram', position: pos(11, 2), data: { label: 'teva_evaluations',            variant: 'table' } },
...
const EDGES: Edge[] = [
  ...
  edge('e11', 'evaluate',      'bottom-src', 'teva',          'top-tgt'),
  edge('e12', 'purge',         'right-src',  'tgam',          'left-tgt'),
  edge('e13', 'purge',         'right-src',  'tpos',          'left-tgt'),
  edge('e14', 'purge',         'right-src',  'teva',          'left-tgt'),
  ...
  edge('e19', 'teva',          'right-src',  'deepenpopular', 'left-tgt'),
  edge('e20', 'deepenpopular', 'left-src',   'teva',          'right-tgt'),
