...
//    classes to match this project's existing tab look (px-4/py-2/text-blue-600). Pill variant
//    is left at MyTab's own defaults, which already match this project's existing pill tabs.
//
//    Parameters:
//      props — forwarded as-is to MyTab (see nextjs-shared/MyTab)
//==================================================================================================
