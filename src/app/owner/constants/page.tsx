...
const CONSTANTS_SECTIONS: ConstantSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'MOVE_COUNT_MIN_MOVE_Player', value: MOVE_COUNT_MIN_MOVE_Player, description: "The Analyze page's ×N move-play-count badge/check only applies from this move number onward. Deliberately separate from MIN_ANALYSIS_MOVE_Player.", consumers: ['ChessBoardView_shared.tsx: ChessBoardView_shared'] },
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'POSITION_GAMES_ROWS_DEFAULT_Player', value: POSITION_GAMES_ROWS_DEFAULT_Player, description: "Default rows-per-page for the Analyze page's Games Played panel.", consumers: ['ChessBoardView_shared.tsx: ChessBoardView_shared'] },
      { name: 'POSITION_GAMES_ROWS_OPTIONS_Player', value: POSITION_GAMES_ROWS_OPTIONS_Player, description: "Rows-per-page dropdown options for the Analyze page's Games Played panel.", consumers: ['ChessBoardView_shared.tsx: ChessBoardView_shared'] },
