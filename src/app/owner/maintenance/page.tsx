...
import { getPlayer, upsertPlayer, getPlayers, upsertPlayerRating, markPlayerSynced } from '@/src/lib/actions/players'
...
import { DEFAULT_PLAYER, INCLUDED_TIME_CLASSES, getPlayerTimeClasses } from '@/src/lib/constants'
...
export default function MaintenancePage() {
  ...
  async function handleSyncComplete() {
    ...
    if (player) {
      ...
      setGameCount(rawCount)
      await markPlayerSynced(player.username, Math.floor(Date.now() / 1000))
    }
  }
