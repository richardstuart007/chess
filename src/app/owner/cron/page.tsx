...
export default function CronPage() {
  ...
  const [analysisResult,  setAnalysisResult]  = useState<{ players: { username: string; gamesProcessed: number; positions: number; treeBuilt: number; remaining: number; errors: number }[] } | null>(null)
    ...
    <div className='space-y-4'>
      ...
      <MyBox title='Analysis Pipeline — All Players'>
        <div className='flex items-center gap-2 mb-2'>
          ...
          <MyHelpField text='Builds the position tree for all players. Run after Game Sync.' />
        </div>
